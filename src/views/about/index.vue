<template>
  <div>
    <div class="card mb10">
      ...
      <span class="text">
        <el-link href="https://gitee.com/haimashale/geeker-admin-js" target="_blank" type="primary">Geeker-Admin-JS</el-link>
    ...
    <div class="card mb10">
      ...
      <el-descriptions :column="2" border>
        ...
        <el-descriptions-item label="Gitee" label-align="left">
          <el-link href="https://gitee.com/haimashale/geeker-admin-js" target="_blank" type="primary"> Gitee</el-link>
        </el-descriptions-item>
        <el-descriptions-item label="Github" label-align="left">
          <el-link href="https://github.com/lw123lw/Geeker-Admin-JS" target="_blank" type="primary"> Github</el-link>
        </el-descriptions-item>
        ...
        <el-descriptions-item label="预览地址" label-align="left">
          <el-link href="https://geeker.liwei.online/" target="_blank" type="primary"> 预览地址</el-link>
        </el-descriptions-item>
      </el-descriptions>
    </div>
    <div class="card mb10">
